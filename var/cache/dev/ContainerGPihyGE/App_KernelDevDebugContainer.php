...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            ...
            'App\\Controller\\BibliometrController' => 'getBibliometrControllerService',
            'App\\Controller\\DeleteArticleController' => 'getDeleteArticleControllerService',
            ...
            'App\\Controller\\UserPanelController' => 'getUserPanelControllerService',
    ...
    protected function getArticleControllerService()
    {
        ...
        $instance->setContainer(($this->privates['.service_locator.SXie53V'] ?? $this->get_ServiceLocator_SXie53VService())->withContext('App\\Controller\\ArticleController', $this));

        return $instance;
    }

    /**
     * Gets the public 'App\Controller\BibliometrController' shared autowired service.
     *
     * @return \App\Controller\BibliometrController
     */
    protected function getBibliometrControllerService()
    {
        $this->services['App\\Controller\\BibliometrController'] = $instance = new \App\Controller\BibliometrController();

        $instance->setContainer(($this->privates['.service_locator.SXie53V'] ?? $this->get_ServiceLocator_SXie53VService())->withContext('App\\Controller\\BibliometrController', $this));

        return $instance;
    }

    /**
     * Gets the public 'App\Controller\DeleteArticleController' shared autowired service.
     *
     * @return \App\Controller\DeleteArticleController
     */
    protected function getDeleteArticleControllerService()
    {
        $this->services['App\\Controller\\DeleteArticleController'] = $instance = new \App\Controller\DeleteArticleController();

        $instance->setContainer(($this->privates['.service_locator.SXie53V'] ?? $this->get_ServiceLocator_SXie53VService())->withContext('App\\Controller\\DeleteArticleController', $this));
    ...
    protected function getRegisterControllerService()
    {
        ...
        $instance->setContainer(($this->privates['.service_locator.SXie53V'] ?? $this->get_ServiceLocator_SXie53VService())->withContext('App\\Controller\\RegisterController', $this));
    ...
    /**
     * Gets the public 'App\Controller\UserPanelController' shared autowired service.
     *
     * @return \App\Controller\UserPanelController
     */
    protected function getUserPanelControllerService()
    {
        $this->services['App\\Controller\\UserPanelController'] = $instance = new \App\Controller\UserPanelController();

        $instance->setContainer(($this->privates['.service_locator.SXie53V'] ?? $this->get_ServiceLocator_SXie53VService())->withContext('App\\Controller\\UserPanelController', $this));
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('MLwgM5R9ox', 0, ($this->targetDir.''.'/pools'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL))));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('dcwDzZb3Fc', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    /**
     * Gets the private '.service_locator.ecjvmrx' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_EcjvmrxService()
    {
        return $this->privates['.service_locator.ecjvmrx'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Controller\\ArticleController::addArticle' => ['privates', '.service_locator..UeDvn1', 'get_ServiceLocator__UeDvn1Service', false],
            'App\\Controller\\RegisterController::register' => ['privates', '.service_locator.ccM2MGC', 'get_ServiceLocator_CcM2MGCService', false],
     ...
     */
    protected function getAuthAuthenticatorService()
    {
        return $this->privates['App\\Security\\AuthAuthenticator'] = new \App\Security\AuthAuthenticator(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), ($this->services['router'] ?? $this->getRouterService()), ($this->services['security.csrf.token_manager'] ?? $this->getSecurity_Csrf_TokenManagerService()), ($this->services['security.password_encoder'] ?? $this->getSecurity_PasswordEncoderService()));
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('o9ftj4vuHA', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('XNcwZkvlC8', 0, ($this->targetDir.''.'/pools'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL))));
        $a->setLogger(($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('qw+So3bD3Y', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('tbxeYOKBeQ', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('II+krlIGp9', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('cG1ABAMnyL', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['debug.argument_resolver.not_tagged_controller'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\TraceableValueResolver(new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\NotTaggedControllerValueResolver(($this->privates['.service_locator.ecjvmrx'] ?? $this->get_ServiceLocator_EcjvmrxService())), ($this->privates['debug.stopwatch'] ?? ($this->privates['debug.stopwatch'] = new \Symfony\Component\Stopwatch\Stopwatch(true))));
    }
    ...
    protected function getSecurity_Authentication_Listener_Guard_MainService()
    {
        ...
        return $this->privates['security.authentication.listener.guard.main'] = new \Symfony\Component\Security\Guard\Firewall\GuardAuthenticationListener($a, ($this->privates['security.authentication.manager'] ?? $this->getSecurity_Authentication_ManagerService()), 'main', new RewindableGenerator(function () {
            yield 0 => ($this->privates['App\\Security\\AuthAuthenticator'] ?? $this->getAuthAuthenticatorService());
    ...
    protected function getSecurity_Authentication_Provider_Guard_MainService()
    {
        return $this->privates['security.authentication.provider.guard.main'] = new \Symfony\Component\Security\Guard\Provider\GuardAuthenticationProvider(new RewindableGenerator(function () {
            yield 0 => ($this->privates['App\\Security\\AuthAuthenticator'] ?? $this->getAuthAuthenticatorService());
        }, 1), ($this->privates['security.user.provider.concrete.db_provider'] ?? $this->getSecurity_User_Provider_Concrete_DbProviderService()), 'main', new \Symfony\Component\Security\Core\User\UserChecker(), ($this->services['security.password_encoder'] ?? $this->getSecurity_PasswordEncoderService()));
    }
    ...
    protected function getSecurity_ContextListener_0Service()
    {
        return $this->privates['security.context_listener.0'] = new \Symfony\Component\Security\Http\Firewall\ContextListener(($this->privates['security.untracked_token_storage'] ?? ($this->privates['security.untracked_token_storage'] = new \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorage())), new RewindableGenerator(function () {
            yield 0 => ($this->privates['security.user.provider.concrete.db_provider'] ?? $this->getSecurity_User_Provider_Concrete_DbProviderService());
    ...
    {
        return $this->privates['security.user.provider.concrete.db_provider'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider(($this->services['doctrine'] ?? $this->getDoctrineService()), 'App\\Entity\\User', 'name', NULL);
    }
