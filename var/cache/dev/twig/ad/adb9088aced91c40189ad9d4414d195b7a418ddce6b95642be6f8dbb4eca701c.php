...
class __TwigTemplate_54dc79dc71f72e05b2a134993b40fe5d5ce11a180c011c7398eb592e483c67fd extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        // line 1
        echo "    <h1>SYSTEM BIBLIOMETRYCZNY</h1>
...
";
    ...
    {
        return new Source("    <h1>SYSTEM BIBLIOMETRYCZNY</h1>

    {% if app.user %}
    <div class=\"logged-as\">
        <p >Zalogowany jako: {{ app.user.username }}</p>
    </div>
{% endif %}", "inc/header.html.twig", "C:\\xampp\\htdocs\\symfony-project\\templates\\inc\\header.html.twig");
    }
}
